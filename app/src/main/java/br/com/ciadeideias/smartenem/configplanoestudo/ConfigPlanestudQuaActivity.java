...
public class ConfigPlanestudQuaActivity extends AppCompatActivity
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)){
            ...
            Intent it = new Intent(ConfigPlanestudQuaActivity.this, PlanEstuActivity.class);
            startActivity(it);
            finish();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_premium) {
            Intent it = new Intent(ConfigPlanestudQuaActivity.this, PremiumActivity.class);
            startActivity(it);
            finish();
        } else if (id == R.id.nav_home) {
            Intent it = new Intent(ConfigPlanestudQuaActivity.this, SplashActivity.class);
            startActivity(it);
            finish();

        } else if (id == R.id.nav_calendario){
            Toast.makeText(ConfigPlanestudQuaActivity.this, "Voce Clicou no Menu Calendário", Toast.LENGTH_SHORT).show();
            ...
            Intent it = new Intent(ConfigPlanestudQuaActivity.this, MetasActivity.class);
            startActivity(it);
            finish();

        } else if (id == R.id.nav_desemp) {
            Intent it = new Intent(ConfigPlanestudQuaActivity.this, DesempenhoActivity.class);
            startActivity(it);
            finish();

        } else if (id == R.id.nav_ajuda) {
            Toast.makeText(ConfigPlanestudQuaActivity.this, "Voce Clicou no Menu Ajuda", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.nav_sobre) {
            Intent it = new Intent(ConfigPlanestudQuaActivity.this, AboutActivity.class);
            startActivity(it);
            finish();
