...
public class ConfigPlanestudQuiActivity extends AppCompatActivity
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)){
            ...
            Intent it = new Intent(ConfigPlanestudQuiActivity.this, PlanEstuActivity.class);
            startActivity(it);
            finish();
        }
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_premium) {
            Intent it = new Intent(ConfigPlanestudQuiActivity.this, PremiumActivity.class);
            startActivity(it);
            finish();
        } else if (id == R.id.nav_home) {
            Intent it = new Intent(ConfigPlanestudQuiActivity.this, SplashActivity.class);
            startActivity(it);
            finish();

        } else if (id == R.id.nav_calendario){
            Toast.makeText(ConfigPlanestudQuiActivity.this, "Voce Clicou no Menu Calendário", Toast.LENGTH_SHORT).show();
            ...
            Intent it = new Intent(ConfigPlanestudQuiActivity.this, MetasActivity.class);
            startActivity(it);
            finish();

        } else if (id == R.id.nav_desemp) {
            Intent it = new Intent(ConfigPlanestudQuiActivity.this, DesempenhoActivity.class);
            startActivity(it);
            finish();

        } else if (id == R.id.nav_ajuda) {
            Toast.makeText(ConfigPlanestudQuiActivity.this, "Voce Clicou no Menu Ajuda", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.nav_sobre) {
            Intent it = new Intent(ConfigPlanestudQuiActivity.this, AboutActivity.class);
            startActivity(it);
            finish();
