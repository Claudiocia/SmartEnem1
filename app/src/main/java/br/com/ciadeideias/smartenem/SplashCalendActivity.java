...
import br.com.ciadeideias.smartenem.parse.DOMParseCalendHtml;
import br.com.ciadeideias.smartenem.parse.RSSFeed;

/**
 * Created by ClaudioSouza on 01/11/2016.
 */
public class SplashCalendActivity extends AppCompatActivity {
    String RSSFEEDURL = "http://www.smartenem.com.br/calendarios/index";
    RSSFeed feed;
    String fileName;
    ...
    private void startLisActivity(RSSFeed feed){
        ...
        Intent it = new Intent(SplashCalendActivity.this, ListCalendActivity.class);
        it.putExtras(bundle);
        startActivity(it);
    ...
    private class AsyncLoadXMLFeed extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... params) {
            DOMParseCalendHtml myParser = new DOMParseCalendHtml();
