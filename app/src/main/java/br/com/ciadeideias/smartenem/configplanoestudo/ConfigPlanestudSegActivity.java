...
public class ConfigPlanestudSegActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_premium) {
            Intent it = new Intent(ConfigPlanestudSegActivity.this, PremiumActivity.class);
            startActivity(it);
            finish();
        } else if (id == R.id.nav_home) {
            Intent it = new Intent(ConfigPlanestudSegActivity.this, SplashActivity.class);
            startActivity(it);
            finish();
            ...
            Intent it = new Intent(ConfigPlanestudSegActivity.this, MetasActivity.class);
            startActivity(it);
            finish();

        } else if (id == R.id.nav_desemp) {
            Intent it = new Intent(ConfigPlanestudSegActivity.this, DesempenhoActivity.class);
            startActivity(it);
            finish();

        } else if (id == R.id.nav_compart){
            Toast.makeText(ConfigPlanestudSegActivity.this, "Voce Clicou no Menu Videos", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.nav_ajuda) {
            Toast.makeText(ConfigPlanestudSegActivity.this, "Voce Clicou no Menu Ajuda", Toast.LENGTH_SHORT).show();

        } else if (id == R.id.nav_sobre) {
            Intent it = new Intent(ConfigPlanestudSegActivity.this, AboutActivity.class);
            startActivity(it);
            finish();
